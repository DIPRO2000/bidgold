...
function Sports() {
  ...
  return (
    <div className="bg-[#47B67C] rounded-md p-6 w-full max-w-6xl mx-auto shadow-lg">
      ...
      <div className="grid grid-cols-5 gap-8">
        {sports.map((sport) => (
          <button
            ...
            className={`flex flex-col items-center justify-center px-4 py-6 min-h-[120px] rounded-lg  shadow-black transition
