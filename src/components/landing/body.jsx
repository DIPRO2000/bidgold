...
const Body = () => {
  return (
    <section className="w-screen flex flex-col items-center">
      ...
      {/* Feedback Image & Form */}
      {/* <img src="/landingassets/Feedback.svg" alt="Feedback" className="w-full" /> */}
      <div className="w-[80%] md:w-[60%] bg-white shadow-lg rounded-lg p-6 mt-6 border border-gray-300">
        ...
        <textarea className="w-full h-40 p-3 border border-gray-400 rounded-md focus:ring-2 focus:ring-green-500 text-black" placeholder="Share your thoughts with us..."></textarea>
        <button className="mt-6 px-9 py-3 bg-green-700 text-white font-bold rounded-md shadow-md hover:bg-green-800">
          SUBMIT
        </button>
      </div>
    </section>
