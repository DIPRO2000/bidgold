    ...
    <>
      <div className="relative flex justify-center bg-white px-4 dark:bg-[#2D2D2D]">
        ...
        <div className="bg-gradient-to-b from-[#47B67C] to-[#208C53] p-8 rounded-lg shadow-2xl w-full m-20 mx-36 relative z-10">
          ...
          <div className="flex flex-col font-bold md:flex-row justify center  mt-4">
            <div className="w-1/2">
              <p>
              ...
              {/* DONE Button */}
              <button
                className={`mt-6 dark:bg-[#2D2D2D] bg-white text-green-600 w-full font-bold sm:w-1/3 md:w-1/4 lg:w-1/5 border-2 border-black p-4 rounded-md shadow-inner shadow-black transition-all duration-300
        ...
        <button 
  className="text-center w-2/3 dark:bg-[#5D5D5D] md:w-[1190px] max-w-[1190px] h-8 bg-[#D9D9D9] flex justify-center font-bold items-center gap-3 transition-all duration-300 hover:bg-gradient-to-b hover:from-[#47B67C] hover:to-[#208C53] hover:text-black"
